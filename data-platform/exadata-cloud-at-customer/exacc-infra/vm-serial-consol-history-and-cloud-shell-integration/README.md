...
# Key Benefits
These features automate certain common administrative tasks related to usage of the VM serial console for simplicity and convenience, saving precious time and reducing guesswork for our users.
