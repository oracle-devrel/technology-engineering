...
Data Transforms is an easy-to-use graphical user interface that Oracle Autonomous Database, or OCI Goldengate users can use to design graphical data transformations for data integration.
