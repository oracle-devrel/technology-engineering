# Select AI Getting Started - Translation
 
Use this asset as a reference for getting started with the Select AI Translation capabilities available within the Oracle AI Database.
