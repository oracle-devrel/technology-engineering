...
(GIS) applications. Once spatial data is stored in an Oracle AI Database, it can be easily manipulated, retrieved, and related to all other data stored in the database.
...
- [Oracle Spatial Studio Documentation](https://docs.oracle.com/en/database/oracle/spatial-studio/index.html)
