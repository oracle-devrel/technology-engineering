...
**[Download the portable OKE DevOps Starter skill](downloads/use-oke-devops-starter.zip)**

The `use-oke-devops-starter` skill helps application developers and cluster
...
compatible AI agent. See the [AI Agent Skill guide](docs/ai-agent-skill.md) for
...
- [AI Agent Skill](docs/ai-agent-skill.md): download the portable skill for using generated application and cluster-administration workflows.
