# ExaDB-C@C and ExaDB-D Dynamic Scaling

Last reviewed: 2026-06-16

# What is this asset?

This asset introduces a Dynamic Scaling operating pattern for Oracle Exadata Cloud@Customer (ExaDB-C@C, formerly ExaCC) and Oracle Exadata Cloud Service on Dedicated Infrastructure (ExaDB-D, formerly ExaCS) deployments operated through OCI-side control-plane automation.
...
The detailed walkthrough is available as a PDF in the [OdyS_ODCC_v0.1.pdf](./files/OdyS_ODCC_v0.1.pdf).
