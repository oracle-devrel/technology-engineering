...
The contract-pinned OCI Landing Zone handoff has one project compartment.
Require its App, DB, and Infra role-alias rows to contain that same
compartment OCID; the network subnet rows remain distinct.
