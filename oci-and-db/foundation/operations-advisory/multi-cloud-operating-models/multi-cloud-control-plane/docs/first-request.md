...
```json
{"autonomous_databases_configuration":{"adb_dev_project01":{"display_name":"adb-dev-project01","admin_password":"__ADB_DEV_PROJECT01_ADMIN_PASSWORD__"}}}
```

The single merged manifest is:

```json
{"autonomous_databases_configuration":{"adb_existing":{"display_name":"adb-existing"},"adb_dev_project01":{"display_name":"adb-dev-project01","admin_password":"__ADB_DEV_PROJECT01_ADMIN_PASSWORD__"}}}
```
