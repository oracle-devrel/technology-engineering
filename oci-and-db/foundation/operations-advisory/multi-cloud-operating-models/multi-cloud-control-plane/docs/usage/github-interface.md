...
4. Name the branch and commit after the requested resource or operation.
5. Open the pull request, review the plan or check, obtain approval, and merge.
...
git add "$MANIFEST"
git commit -m "Request orders API development VM"
