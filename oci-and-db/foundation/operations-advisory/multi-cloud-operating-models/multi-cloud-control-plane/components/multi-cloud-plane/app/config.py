...
class Settings(BaseSettings):
    ...
    # GitHub integration
    github_org: str = "__CUSTOMER_ORG__"
    ...
    # Application settings
    # HOST and PORT remain supported as common hosting aliases.
    ...
    app_url: str = "http://localhost:8001"  # For OAuth callback
