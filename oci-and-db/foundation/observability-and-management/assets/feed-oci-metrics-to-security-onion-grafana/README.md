...
![Picture 22](./files/image-01.png)

![Picture 21](./files/image-02.png)
...
![Picture 19](./files/image-04.png)

![Picture 18](./files/image-05.png)

2- Create a dedicated user and group (You can also use Dynamic Groups as this instance runs on OCI) for monitoring

Press enter or click to view image in full size

![Picture 17](./files/image-06.png)

![Picture 16](./files/image-07.png)

Press enter or click to view image in full size

![Picture 15](./files/image-08.png)
...
![Picture 11](./files/image-11.png)

![Picture 10](./files/image-12.png)

Press enter or click to view image in full size

![Picture 9](./files/image-13.png)

Press Install:

Press enter or click to view image in full size

![Picture 8](./files/image-14.png)

After press Create a Oracle Cloud Infrastructure metrics data source:

Press enter or click to view image in full size

![Picture 7](./files/image-15.png)

Press Save&test

Press enter or click to view image in full size

![Picture 6](./files/image-16.png)

If you get this, then you need to check the configuration:

Press enter or click to view image in full size

![Picture 5](./files/image-17.png)

Go to Configuration==>Data Sources

![Picture 4](./files/image-18.png)

Click on Oracle Cloud Infrastructure Metrics:

Press enter or click to view image in full size

![Picture 3](./files/image-19.png)

Populate with he Tenancy OCID , Region and Enviornment:

Press enter or click to view image in full size

![Picture 2](./files/image-20.png)

Go to Explore and see the collected metrics.

Press enter or click to view image in full size

![Picture 1](./files/image-21.png)
