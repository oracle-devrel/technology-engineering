...
The parser examples and dashboard template are sanitized. Provide your real tenancy and compartment identifiers only as Resource Manager input variables; do not add them to the exported parser, dashboard, or sample variable files.

## Deploy on Oracle Cloud

[![Deploy to Oracle Cloud](https://oci-resourcemanager-plugin.plugins.oci.oraclecloud.com/latest/deploy-to-oracle-cloud.svg)](https://cloud.oracle.com/resourcemanager/stacks/create?zipUrl=https://github.com/oracle-devrel/technology-engineering/raw/refs/heads/main/oci-and-db/foundation/observability-and-management/log-analytics/finops/multicloud-finops/files/finops-mc-oci-stack.zip)
