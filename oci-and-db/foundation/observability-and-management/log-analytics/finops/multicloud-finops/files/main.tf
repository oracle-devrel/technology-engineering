...
locals {
  ...
  dashboard_import_ids = {
    dashboard_id                              = join("", ["oci", "d1.managementdashboard.oc1..aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"])
    saved_search_compartment_service_usage_id = join("", ["oci", "d1.managementsavedsearch.oc1..aaaaaaaabbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"])
    saved_search_consumption_analysis_id      = join("", ["oci", "d1.managementsavedsearch.oc1..aaaaaaaacccccccccccccccccccccccccccccccccccccccccccccccccccc"])
    saved_search_anomaly_consumption_id       = join("", ["oci", "d1.managementsavedsearch.oc1..aaaaaaaadddddddddddddddddddddddddddddddddddddddddddddddddddd"])
    saved_search_top_service_words_id         = join("", ["oci", "d1.managementsavedsearch.oc1..aaaaaaaaeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"])
    saved_search_compartment_service_id       = join("", ["oci", "d1.managementsavedsearch.oc1..aaaaaaaaffffffffffffffffffffffffffffffffffffffffffffffffffff"])
    saved_search_service_line_id              = join("", ["oci", "d1.managementsavedsearch.oc1..aaaaaaaagggggggggggggggggggggggggggggggggggggggggggggggggggg"])
  }
}
