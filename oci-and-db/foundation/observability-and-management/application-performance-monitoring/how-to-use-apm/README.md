...
- **[What does OCI APM do?](./files/what-does-oci-apm-do.md)**: This is a basic introduction to what OCI APM actually does: the telemetry it collects and the value of this for monitoring.

- **[Discover Application Bottlenecks](./files/discover-application-bottlenecks.md)**: How do you detect application performance bottlenecks in OCI APM? This part will focus on **dashboards, alarms, and proactive availability monitors** as tools to spot or notify you about bottlenecks to be explored further.

- **[Explore Application Bottlenecks](./files/explore-application-bottlenecks.md)**: After discovering a bottleneck, how do you explore the related telemetry of traces and spans? What exactly are you looking for? This part will focus on APM's **Trace Explorer**, a tool to dig around your traces freely.
