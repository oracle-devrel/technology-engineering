...
>
> Start with the [README](https://github.com/oci-landing-zones/oci-cis-landingzone-quickstart/blob/main/README.md#script_standard) as the instructions have been updated to accommodate the new structure.
> 
