...
This folder contains the AskOracle chatbot-viz version 3 assets required to run the application. For this version to function correctly and render graph data successfully, ensure the following components are in place:

1. Import the [AskOracle chatbot-viz application](https://github.com/oracle-devrel/oracle-autonomous-database-samples/tree/main/apex/Ask-Oracle-Select-AI-Chatbot/V%205.0.0.1) (or adjust to the latest version).
2. Install the [Graph Visualization plug-in](https://github.com/oracle/apex/tree/26.1/plugins/region/graph-visualization).
