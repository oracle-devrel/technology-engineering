# Generative Development with APEX
...
This area focuses on generative development patterns with Oracle APEX, including :
- APEXlang
...
- integration patterns with Oracle AI services.
...
- [Oracle APEX AI Application Generator and APEXlang](https://www.oracle.com/apex/ai-application-generator/)
- [Introducing APEXlang: The Future of Generative Application Development with Oracle APEX](https://blogs.oracle.com/apex/introducing-apexlang-the-future-of-generative-application-development-with-oracle-apex)
- [APEXlang in Practice: Export, Edit, Validate, and Import Oracle APEX Applications](https://blogs.oracle.com/apex/apexlang-in-practice-export-edit-validate-and-import-oracle-apex-applications)
...
- [Talk to Your Data, Trust the Result: Introducing APEX AI Interactive Reports](https://blogs.oracle.com/apex/introducing-apex-ai-interactive-reports)
...
- [APEX Documentation](https://docs.oracle.com/en/database/oracle/apex/26.1/index.html)
- [Managing AI Agents and Tools in APEX](https://docs.oracle.com/en/database/oracle/apex/26.1/htmdb/managing-ai-agents-and-ai-tools.html)
- [Oracle APEX AI Application Generator and APEXlang](https://www.oracle.com/apex/ai-application-generator/)
- [APEXlang in Practice: Export, Edit, Validate, and Import Oracle APEX Applications](https://blogs.oracle.com/apex/apexlang-in-practice-export-edit-validate-and-import-oracle-apex-applications)
...
Oracle APEX 26.1 introduces new AI-powered development capabilities for building trusted enterprise applications. Key areas include:

- APEXlang for declarative, reviewable, source-controlled application specifications
- AI-assisted application generation
- AI Interactive Reports for natural language report exploration
- AI Agents and AI Tools for governed conversational actions inside APEX applications
- Generative AI support in application development workflows
- Support for structured development with SQL Developer for VS Code and SQLcl
