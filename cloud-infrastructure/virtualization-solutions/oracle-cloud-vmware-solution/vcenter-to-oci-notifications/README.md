# Oracle Cloud VMware Solution - vCenter Alarm integration with OCI Notifications
...
This document serves as an asset for individuals and organisations seeking to monitor their Oracle Cloud VMware Solution by leveraging the OCI Notification service.

# How to use this Asset

Use the README file in the files folder as a starting point for integrating the vCenter Alarms to the OCI Notification Service.
