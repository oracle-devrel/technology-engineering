# Select AI Getting Started - Summarization
 
Use this asset as a reference for getting started with the Select AI Summarization capabilities available within the Oracle AI Database.
