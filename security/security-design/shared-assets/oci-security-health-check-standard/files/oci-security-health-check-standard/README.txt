...
Version: 240502 (cis_report.py version 2.8.1)
...
2 Using the Cloud Shell
  ...
  - When running it the first time:
    ...
    - Extract it with unzip -q oci-security-health-check-standard-240502.zip
...
### Using an OCI Compute VM (Oracle Linux)
  ...
  - From your desktop, upload the
    "oci-security-health-check-standard-240502.zip" file to the Compute VM
