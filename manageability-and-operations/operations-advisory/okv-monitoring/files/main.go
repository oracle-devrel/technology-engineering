...
// execute go mod init
// execute go mod tidy
// run the program as go run main.go -target="okv_ip" -Port=161 -UserName="okv_snmp_user" -AuthenticationPassphrase="okv_snmp_user" -PrivacyPassphrase="okv_snmp_user"
...
*/
	...
	//err = params.BulkWalk(".1.3.6.1.4.1.2021.2", printValue)
	//err = params.BulkWalk(".1.3.6.1.4.1.2021.2.1.2.3", printValue)
	// err = params.BulkWalk(".1.3.6.1.4.1.2021.2.1.2", printValue)
	//values,err = params.BulkWalkAll(".1.3.6.1.4.1.2021.2.1")
	if err != nil {
