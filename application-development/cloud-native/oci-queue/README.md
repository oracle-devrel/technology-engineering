...
## OCI queue overview
[Document queue-overview](https://github.com/oracle-devrel/technology-engineering/blob/martatolosa-queue/application-development/cloud-native/oci-queue/queue_overview.pdf)
