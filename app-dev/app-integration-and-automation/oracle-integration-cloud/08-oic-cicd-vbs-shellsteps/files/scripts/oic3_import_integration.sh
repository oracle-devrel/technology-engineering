#!/bin/bash
# ****************************************************************************************
# Script: oic3_import_integration.sh
#
# This script is implementing comand to import integration (.iar) from the OIC environment as part of CICD Implementation for OCI/OIC - it is expected that before the build the .iar file is archived during the previous build or step
#
# Oracle 
...
# Last updated comments:The script is importing global integration - adaptation based on https://docs.oracle.com/en/cloud/paas/application-integration/rest-api/rest-endpoints.html 
#                        
