#!/bin/bash
# ****************************************************************************************
# Script: oic3_export_lookup.sh
#
# This script is implementing comand to export the lookup from the OIC environment as part of CICD Implementation for OCI/OIC 
#
# Oracle 
...
# Last updated comments:The script is exporting global lookup - adaptation based on https://docs.oracle.com/en/cloud/paas/application-integration/rest-api/rest-endpoints.html 
#                        
...
if [ "$http_status" != "200" ]; then
    echo "Error: Export lookup failed with HTTP status code: $http_status" >&2
    exit 1
fi
