#!/bin/bash
# ****************************************************************************************
# Script: oic3_export_integration.sh
#
# This script is implementing comand to export integration (.iar) from the OIC environment as part of CICD Implementation for OCI/OIC - it is expected that after the build the .iar file is archived for the follow-up builds 
#
# Oracle 
...
# Last updated comments:The script is exporting global integration - adaptation based on https://docs.oracle.com/en/cloud/paas/application-integration/rest-api/rest-endpoints.html 
#                        
...
if [ "$http_status" != "200" ]; then
    echo "Error: Export integration failed with HTTP status code: $http_status" >&2
    exit 1
fi
