# How to integrate Service Now with Oracle cloud Alarms
...
3. Create and deploy function using [Cloudshell](https://docs.oracle.com/en-us/iaas/Content/Functions/Tasks/functionsquickstartcloudshell.htm)
