# Enable OCI Observability On Autonomous Shared Database

Last converted: 2026-06-09

Source: [How to enable OCI Observability on Autonomous Shared Database](https://medium.com/@erikasciunzi/how-to-enable-oci-observability-on-autonomous-shared-database-716b623d1f15)
...
![Autonomous Shared Database observability architecture](assets/architecture.svg)

Updated diagram based on the requested architecture reference and the Medium
article. The original article image is retained as
[`assets/architecture.webp`](assets/architecture.webp).

Editable Draw.io source:
[`assets/architecture.drawio`](assets/architecture.drawio).
